...
import personal.project.doculysis.operations_summary.getSummaryFromText;
import personal.project.doculysis.operations_summary.getSummaryFromurl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_loadfileforsummaryoption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(summary_option.this, getSummaryFromFile.class));
                finish();
            }
        });
